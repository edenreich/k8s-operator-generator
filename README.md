...
Download and install the latest `kopgen CLI` [for ARM64](https://github.com/edenreich/k8s-operator-generator/releases/download/latest/kopgen_aarch64-unknown-linux-musl) or [for x86_64 Intel](https://github.com/edenreich/k8s-operator-generator/releases/download/v1.0.0/kopgen_x86_64-unknown-linux-musl).
