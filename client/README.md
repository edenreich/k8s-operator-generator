# Rust API client for pets_api_client
...
Put the package under your project folder in a directory named `pets_api_client` and add the following to `Cargo.toml` under `[dependencies]`:

```
pets_api_client = { path = "./pets_api_client" }
```
